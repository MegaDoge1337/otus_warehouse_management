...
class TestSuite(unittest.TestCase):
    ...
    def test_add_get_customer(self, name, orders):
        customer_orm = CustomerORM(name=name, orders=orders)
    ...
    @cases([("product", 10, 500.0)])
    def test_order_product_relations(
        self, product_name, product_quantity, product_price
    ):
    ...
    def test_customer_order_relations(self, customer_name, order_products):
        ...
        customer_orm = CustomerORM(name=customer_name, orders=[order_orm])
