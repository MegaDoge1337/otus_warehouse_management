    ...
    with uow:
        while True:
            ...
            if user_input == "1":
                ...
                new_product = warehouse_service.create_product(name=product_name, 
            ...
            if user_input == "2":
                ...
                for product_id in product_ids.split(","):
                    products.append(warehouse_service.get_product(product_id=int(product_id)))
            ...
            if user_input == "3":
                ...
                new_customer = warehouse_service.create_customer(name=customer_name, 
                                                                orders=orders)
                uow.commit()
